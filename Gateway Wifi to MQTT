// Kode GATEWAY (ESP32) dengan NimBLE, mqtt wifi (Menggunakan JSON)
#include <Wire.h>
...
// --- Konfigurasi WiFi ---
const char* ssid = "coba";          // Ganti dengan SSID WiFi Anda
const char* password = "123456789"; // Ganti dengan password WiFi Anda

// --- Konfigurasi MQTT ---
const char* mqtt_server = "192.168.0.100"; // Ganti dengan IP address server MQTT Anda
